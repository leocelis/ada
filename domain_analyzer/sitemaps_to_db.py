...
# Get all sitemaps
sitemaps_urls = get_all_sitemaps(category='fun')
# sitemaps_urls = get_all_sitemaps(category='adtech', domain='leocelis.com')
# sitemaps_urls = get_all_sitemaps()
# sitemaps_urls = get_all_sitemaps(domain='leocelis.com')
